...
namespace MsgToPdfConverter.Services
{
    ...
    {
        public static void CheckDotNetRuntime(Window owner)
        {
            if (!System.ComponentModel.DesignerProperties.GetIsInDesignMode(owner))
            {
        ...
        {
            string dotnetDir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ProgramFiles), "dotnet", "shared", "Microsoft.WindowsDesktop.App");
